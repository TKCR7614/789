...
@app.route('/')
def welcome():
    return render_template('FC724_assignment_1_Welcome_Page.html')

@app.route('/information')
def information():
    return render_template('FC724_assignment_1_ Information_Page.html')
...
def data_collection():
    ...
    return render_template('FC724_assignment_1 _Data_Collection_Page.html', form=form)
